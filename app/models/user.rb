#All work done within this model was completed by Zachary T. Kaspar 1st
require 'digest'
class User < ActiveRecord::Base
  ...
  attr_accessible :name, :email, :address, :city, :c_state, :zipcode , :password, :password_confirmation,:c_type
