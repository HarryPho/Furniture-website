class OrderLinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order_line.save
        format.html { redirect_to(@order_line, :notice => 'OrderLine was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @order_line.update_attributes(params[:order_line])
        format.html { redirect_to(@order_line, :notice => 'OrderLine was successfully updated.') }
        format.xml  { head :ok }
      else
