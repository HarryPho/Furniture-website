  ...
  def create
    ...
    respond_to do |format|
      if @sales_person.save
        format.html { redirect_to(@sales_person, :notice => 'SalesPerson was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @sales_person.update_attributes(params[:sales_person])
        format.html { redirect_to(@sales_person, :notice => 'SalesPerson was successfully updated.') }
        format.xml  { head :ok }
      else
